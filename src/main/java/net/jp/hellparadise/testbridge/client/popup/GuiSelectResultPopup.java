...
public class GuiSelectResultPopup extends SubGuiScreen {
    ...
    public GuiSelectResultPopup(BlockPos pos, Consumer<UUID> handleResult) {
        ...
        MainProxy.sendPacketToServer(
            PacketHandler.getPacket(RequestResultPipeListPacket.class)
                .setFlag(true)
                .setBlockPos(pos));
    }
    ...
    public void handleResultList(List<Pair<String, UUID>> list) {
        if (list != null) pipeList = new ObjectArrayList<>(list);
    }
}
