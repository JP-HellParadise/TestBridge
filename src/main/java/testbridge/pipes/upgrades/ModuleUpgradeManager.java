  ...
  public void InventoryChanged(IInventory inventory) {
    ...
    for(i = 0; i < this.upgrades.length; ++i) {
      ...
      if (upgrade instanceof SneakyUpgradeConfig && this.sneakyOrientation == null) {
        ...
        this.liquidCrafter += this.inv.getStackInSlot(i).getCount();
        ...
        this.craftingCleanup += this.inv.getStackInSlot(i).getCount();
      } else if (upgrade instanceof ActionSpeedUpgrade) {
        this.actionSpeedUpgrade += this.inv.getStackInSlot(i).getCount();
      } else if (upgrade instanceof ItemExtractionUpgrade) {
        this.itemExtractionUpgrade += this.inv.getStackInSlot(i).getCount();
      } else if (upgrade instanceof ItemStackExtractionUpgrade) {
        this.itemStackExtractionUpgrade += this.inv.getStackInSlot(i).getCount();
      }
