...
public class IISHelper {
  ...
  public static List<ItemIdentifierStack> combine(List<ItemIdentifierStack> stacks) {
    return stacks.stream()
        ...
        .filter(stack -> stack != null && !stack.makeNormalStack().isEmpty())
        .collect(Collectors.groupingBy(ItemIdentifierStack::getItem, Collectors.summingInt(ItemIdentifierStack::getStackSize)))
        .entrySet().stream()
