...
public class AE2Module implements IIntegrationModule {
  ...
  public void preInit() {
    ...
    // Register Part
    AE2Module.SATELLITE_BUS = EnumHelper.addEnum(PartType.class, "SATELLITE_BUS", new Class[]{int.class, String.class, Set.class, Set.class, Class.class},
        1024, "satellite_bus", EnumSet.of( AEFeature.CRAFTING_CPU ), EnumSet.noneOf( IntegrationType.class ), PartSatelliteBus.class);
    Api.INSTANCE.getPartModels().registerModels(AE2Module.SATELLITE_BUS.getModels());
    AE2Module.SATELLITE_BUS_SRC = ItemPart.instance.createPart(AE2Module.SATELLITE_BUS);

    AE2Module.CRAFTINGMANAGER_PART = EnumHelper.addEnum(PartType.class, "CRAFTINGMANAGER_PART", new Class[]{int.class, String.class, Set.class, Set.class, Class.class},
        1025, "craftingmanager_part", EnumSet.of( AEFeature.INTERFACE ), EnumSet.noneOf( IntegrationType.class ), PartCraftingManager.class);
    Api.INSTANCE.getPartModels().registerModels(AE2Module.CRAFTINGMANAGER_PART.getModels());
    AE2Module.CRAFTINGMANAGER_PART_SRC = ItemPart.instance.createPart(AE2Module.CRAFTINGMANAGER_PART);

    // Register GUI
    AE2Module.GUI_CRAFTINGMANAGER = EnumHelper.addEnum(GuiBridge.class, "GUI_CRAFTINGMANAGER", new Class[]{Class.class, Class.class, GuiHostType.class, SecurityPermissions.class},
        ContainerCraftingManager.class, ICraftingManagerHost.class, GuiHostType.WORLD, SecurityPermissions.BUILD);

    AE2Module.GUI_SATELLITESELECT = EnumHelper.addEnum(GuiBridge.class, "GUI_SATELLITESELECT", new Class[]{Class.class, Class.class, GuiHostType.class, SecurityPermissions.class},
  ...
  public void init() {
    ...
    tile_cm = ((IBlocks_TB) AE2Module.INSTANCE.api.definitions().blocks()).cmBlock().maybeStack(1).orElse(ItemStack.EMPTY);
  ...
  private static void loadRecipes() {
    ...
    // Satellite Bus
    ForgeRegistries.RECIPES.register(new ShapedOreRecipe(group, AE2Module.SATELLITE_BUS_SRC.stack(1),
        " c ",
                "ifi",
                " p ",
        'p', Blocks.PISTON,
